...
export declare class Column<T extends ColumnOptions.All = ColumnOptions.All> {
    ...
    static create(name: string, type: ColumnType.BIGINT | ColumnType.DOUBLE | ColumnType.FLOAT | ColumnType.INT | ColumnType.MEDIUMINT | ColumnType.SMALLINT | ColumnType.TINYINT, options?: ColumnOptions.General & ColumnOptions.Precision & ColumnOptions.Unsigned & ColumnOptions.Zerofill): Column<ColumnOptions.General & ColumnOptions.Precision & ColumnOptions.Unsigned & ColumnOptions.Zerofill>;
    ...
    static create(name: string, type: ColumnType.DECIMAL, options?: ColumnOptions.General & ColumnOptions.Precision & ColumnOptions.Scale & ColumnOptions.Unsigned & ColumnOptions.Zerofill): Column<ColumnOptions.General & ColumnOptions.Precision & ColumnOptions.Scale & ColumnOptions.Unsigned & ColumnOptions.Zerofill>;
